        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="index.html" class="header-logo">
                    <h4 class="logo-title text-uppercase">TaskTrail</h4>
                </a>
            </div>

            <div class="navbar-breadcrumb">
                <h4>@yield('section-title')</h4>
            </div>
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right border-none"
                                ...
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="https://templates.iqonic.design/product/lite/webkit/html/app/user-profile.html">My
                                        Profile</a>
                                </li>
                                <li class="dropdown-item  d-flex svg-icon border-top">
                                    ...
                                    <a href="{{ route('logout') }}" class="prevent-default" onclick="$('#logout-form').submit();">Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
