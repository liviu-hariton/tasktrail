...
const TaskTrail = function () {
    const formsValidation = function() {
        ...
        if($("#f-new-role" ).length) {
            const new_role_validator = $('#f-new-role').validate({
                errorClass: 'validation-invalid-label',
                successClass: 'validation-valid-label',
                validClass: 'validation-valid-label',
                highlight: function(element, errorClass) {
                ...
                messages: {
                    name: {
                        required: TaskTrail.translate('rolename', 'required'),
                        minlength: TaskTrail.translate('rolename', 'minlength'),
                        lettersonlysp: TaskTrail.translate('rolename', 'lettersonlysp'),
                    }
                }
            });
        }
